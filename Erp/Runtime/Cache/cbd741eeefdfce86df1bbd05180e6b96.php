...
<form action="<?php echo U('Xiaoqu/editok');?>" method="post">
<table class="table table-bordered table-hover definewidth m10">
<input type="hidden" name="xiaoqu_id" value='<?php echo ($xiaoqu["xiaoqu_id"]); ?>'/>
    <tr>
        <td class="tableleft">小区名称</td>
        <td><input type="text" name="xiaoqu_name" value='<?php echo ($xiaoqu["xiaoqu_name"]); ?>'/></td>
    </tr>
    <tr>
        <td class="tableleft">小区地址</td>
        <td><input type="text" name="address" value='<?php echo ($xiaoqu["address"]); ?>'/></td>
    </tr>
    <tr>
...
<script>
    $(function () {       
		$('#backid').click(function(){
			window.location.href="<?php echo U('Xiaoqu/index');?>";
		 });
